...
from ..models import BaseResponse, StorageIDResponse, StorageListResponse, StorageResponse
...
class StorageAPI:
    ...
    def ls(self, page: int = 1, per_page: int = 0) -> StorageListResponse:
        """列出所有存储。
    ...
    def update(
        ...
        webdav_policy: str | None = None,
        down_proxy_url: str | None = None,
    ) -> StorageIDResponse:
        """更新存储信息。
