...
class SettingAPI:
    ...
    def ls(self, group: int | None = None, groups: str | None = None) -> list[Setting]:
        """列出设置项。
        ...
        Example:
            ...
            >>> settings = setting_api.ls(group=1)  # 获取站点设置
    ...
    def set_aria2(self, uri: str, secret: str = "") -> BaseResponse:
        """设置aria2配置。
    ...
    def set_qbittorrent(self, url: str, seedtime: int = 0) -> BaseResponse:
        """设置qBittorrent配置。
