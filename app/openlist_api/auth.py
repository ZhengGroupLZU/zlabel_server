...
from .models import BaseResponse, Generate2FAResponse, LoginResponse, UserInfoResponse
...
class AuthAPI:
    ...
    def login(self, username: str, password: str, otp_code: str | None = None) -> LoginResponse:
        """获取用户登录token。
