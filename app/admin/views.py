...
from app.admin.auth import admin_context
from app.core.errors import ApiError
from app.core.logging import get_logger
from app.db.models import ROLE_ANNOTATOR, ROLES, STATES, AuditLog
...
class UsersView(_PageView):
    ...
    Every write goes through :class:`~app.services.auth_service.AuthService`, which
...
class ProjectsView(_PageView):
    ...
    def _overview(self, request: Request, project_name: str) -> str:
        ...
        return (
            ...
            "<code>uv run python -m app.cli migrate-anno-ids</code>. <strong>Timeline</strong> off "
