...
from v2.db.models import Annotation, Instance, InstanceResult, Project, Task, utcnow
from v2.services import audit
from v2.services.label_palette import normalize_color, pick_color

logger = get_logger("zlabel.v2.instances")
...
class InstanceService:
    ...
    def sync_project(self, project: str) -> dict[str, int]:
        ...
        Used by ``v2.cli sync-instances`` for datasets annotated before the
