...
from app.contracts.ids import anno_id_for, legacy_anno_id_for
from app.db.models import Annotation, AnnotationVersion, Project, Task
...
def test_migrate_anno_ids_rewrites_files_and_rows(services, settings, db):
    ...
    payload = json.dumps({"id": old_id, "image_path": "images/D1.png", "results": {}}).encode("utf-8")
