...
from app.core.errors import ValidationFailed, WorkerBusy
from app.inference_worker.engine import EmbeddingCache, InferenceEngine
from app.inference_worker.schemas import InferJob
from inference.config import InferenceSettings
from tests.app.fakes import FakeEnginePredictor
...
def worker_client(**settings_kwargs):
    ...
    from app.inference_worker.main import create_worker_app
...
def test_state_filter_accepts_a_list():
    ...
    from app.services.task_service import _split_states
